...
{category:"radm", type:"header", label:"──────────────────"},
{category:"radm", id:"rgb_natural", label:"위성센터: RGB 자연색",
    patternByModel:{
        kim_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-kim-natural_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-kim-natural_ko020lc_{runmin}+{fh}.png"
        ],
        um_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-um-natural_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-um-natural_ko020lc_{runmin}+{fh}.png"
        ],
        ecmwf:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ecmwf-natural_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ecmwf-natural_ko020lc_{runmin}+{fh}.png"
        ]
    },
    forecastStepByModel:{
        kim_gdps:[
            {start:0,end:18,step:1},
            {start:18,end:144,step:3}
        ],
        um_gdps:[
            {start:0,end:18,step:1},
            {start:18,end:144,step:3}
...
{category:"radm", id:"rgb_true", label:"위성센터: RGB 천연색",
    patternByModel:{
        kim_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-kim-true_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-kim-true_ko020lc_{runmin}+{fh}.png"
        ],
        um_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-um-true_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-um-true_ko020lc_{runmin}+{fh}.png"
        ],

        ecmwf:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ecmwf-true_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ecmwf-true_ko020lc_{runmin}+{fh}.png",
        ],
        um_ldps:"https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ldps-true_ko020lc_{runmin}+{fh}.png"
    },
    forecastStepByModel:{
        kim_gdps:[
            {start:0,end:18,step:1},
...
{category:"radm", id:"rgb_daynight", label:"위성센터: RGB 주야간합성",
    patternByModel:{
        kim_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-kim-daynight_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-kim-daynight_ko020lc_{runmin}+{fh}.png"
        ],
        um_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-um-daynight_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-um-daynight_ko020lc_{runmin}+{fh}.png"
        ],
        ecmwf:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ecmwf-daynight_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ecmwf-daynight_ko020lc_{runmin}+{fh}.png"
        ],
        um_ldps:"https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ldps-daynight_ko020lc_{runmin}+{fh}.png"
    },
    forecastStepByModel:{
        kim_gdps:[
            {start:0,end:18,step:1},
...
{category:"radm", id:"rgb_3chwv", label:"위성센터: RGB 3채널 수증기",
    patternByModel:{
        kim_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-kim-3chwv_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-kim-3chwv_ko020lc_{runmin}+{fh}.png"
        ],
        um_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-um-3chwv_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-um-3chwv_ko020lc_{runmin}+{fh}.png"
        ],
        ecmwf:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ecmwf-3chwv_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_rgb-ecmwf-3chwv_ko020lc_{runmin}+{fh}.png"
        ]
    },
    forecastStepByModel:{
        kim_gdps:[
...
{category:"radm", id:"enhc_color_ir105", label:"위성센터: 컬러적외(10.5µm)강조",
    patternByModel:{
        kim_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-ir105-kim_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-ir105-kim_ko020lc_{runmin}+{fh}.png"
        ],
        um_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-ir105-um_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-ir105-um_ko020lc_{runmin}+{fh}.png"
        ],
        ecmwf:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-ir105-ecmwf_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-ir105-ecmwf_ko020lc_{runmin}+{fh}.png"
        ]
    },
    forecastStepByModel:{
        kim_gdps:[
...
{category:"radm", id:"enhc_color_wv063", label:"위성센터: 컬러수증기(6.3µm)강조",
    patternByModel:{
        kim_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv063-kim_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv063-kim_ko020lc_{runmin}+{fh}.png"
        ],
        um_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv063-um_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv063-um_ko020lc_{runmin}+{fh}.png"
        ],
        ecmwf:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv063-ecmwf_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv063-ecmwf_ko020lc_{runmin}+{fh}.png"
        ]
    },
    forecastStepByModel:{
        kim_gdps:[
...
{category:"radm", id:"enhc_color_wv069", label:"위성센터: 컬러수증기(6.9µm)강조",
    patternByModel:{
        kim_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv069-kim_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv069-kim_ko020lc_{runmin}+{fh}.png"
        ],
        um_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv069-um_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv069-um_ko020lc_{runmin}+{fh}.png"
        ],
        ecmwf:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv069-ecmwf_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv069-ecmwf_ko020lc_{runmin}+{fh}.png"
        ]
    },
    forecastStepByModel:{
        kim_gdps:[
...
{category:"radm", id:"enhc_color_wv073", label:"위성센터: 컬러수증기(7.3µm)강조",
    patternByModel:{
        kim_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv073-kim_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv073-kim_ko020lc_{runmin}+{fh}.png"
        ],
        um_gdps:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv073-um_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv073-um_ko020lc_{runmin}+{fh}.png"
        ],
        ecmwf:[
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/EA/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv073-ecmwf_ea020lc_{runmin}+{fh}.png",
            "https://nmsc.kma.go.kr/IMG/GK2A/AMI/PRIMARY/L1B/COMPLETE/KO/{ym}/{day}/{hour}/gk2a_ami_le1b_enhc-color-wv073-ecmwf_ko020lc_{runmin}+{fh}.png"
        ]
    },
    forecastStepByModel:{
        kim_gdps:[
